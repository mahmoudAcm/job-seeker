      ...
      <div>
        <div className='flex flex-col gap-2'>
          ...
          {value?.map(({ file, progress }, i) => (
            <div key={i} className='flex h-16 w-full flex-col justify-center rounded border border-solid px-4 py-2'>
              <div className='flex items-center gap-2 text-black'>
                <FileIcon size='30' className='shrink-0' />
                <div className='min-w-0 text-sm'>
                  <div className='overflow-hidden overflow-ellipsis whitespace-nowrap w-[10ch] sm:w-fit'>
                    {file.name}
                  </div>
